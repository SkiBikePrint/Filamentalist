...
### Flexible Filament ***
  ...
  - 85A hardness TPU (for example NinjaFlex) has been minimally tested and the Filamentalist would load/unload it.  I was unable to performmaterial swap testing within a print as the NinjaFlex was jamming in my extruder due to excessive extrusion rates.  I'll get back to testing this at some point.  If you have had success or failure with the Filamentalist using flexible materials softer than 95A please let me know.
