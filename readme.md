...
1. The MMU gear stepper is doing the heavy lifting.  Any buffer solution adds resistance into the filament path.  Configure your gear stepper to run in sync mode with your extruder (for eaxample via Happy Hare settings).
